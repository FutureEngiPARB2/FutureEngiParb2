...
public class UsbService extends Service {
    ...
    private static final String ACTION_USB_PERMISSION = "com.android.cvpro.USB_PERMISSION";
     ...
     *  In this particular cvpro. byte stream is converted to String and send to UI thread to
     *  be treated there.
     */
